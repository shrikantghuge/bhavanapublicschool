      ...
      <div class="menu_area">
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">  <div class="container">
            <div class="navbar-header">
              ...
              <!-- LOGO -->
              <!-- TEXT BASED LOGO -->
              <a class="navbar-brand" href="index.html">StudyEasy <span>Academy</span></a>              
              <!-- IMG BASED LOGO  -->
	      ...
	      <div class="container">
	        ...
	        <div class="col-lg-6 col-md-6 col-sm-6">
	          <div class="aboutus_area wow fadeInLeft">
	            ...
	            <p>My study easy is the learning center, engaged in teaching for class 8th to 12th for school/ Board Exams, CBSE/PMT Foundation, IIT JEE Foundation and other competitive exams. My Study Easy is organized and managed by highly qualified, experienced professionals from premier Institutions of the country like IIT COEP, MIT and other such professional bodies. The director, who completed his Mechanical Engineering and is the double gold medalist of Amravati University  and M-Tech in Design Engineering from College Of Engineering, Pune. He is highly learned and experienced person in the field of education and Industry work. He had handled the DRDO project during his M-Tech research project.</p>
	          </div>
	        </div>
	        <div class="col-lg-6 col-md-6 col-sm-6">
